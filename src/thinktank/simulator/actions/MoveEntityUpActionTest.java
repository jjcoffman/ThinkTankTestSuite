...
/**
 * The class <code>MoveEntityUpActionTest</code> contains tests for the class <code>{@link MoveEntityUpAction}</code>.
 *
 * @generatedBy CodePro at 12/4/16 12:54 PM
 * @author DoubleJ
 * @version $Revision: 1.0 $
 */
public class MoveEntityUpActionTest {
	/**
	...
	public void testActionPerformed_1()
		throws Exception {
		MoveEntityUpAction fixture = MoveEntityUpActionFactory.createInstance();
	...
	/**
	 * Run the MoveEntityUpAction getInstance() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 12/4/16 12:54 PM
	...
	public void testGetInstance_1()
		...
		MoveEntityUpAction result = MoveEntityUpAction.getInstance();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(MoveEntityUpActionTest.class);
	}
}