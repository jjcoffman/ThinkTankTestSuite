...
/**
 * The class <code>RotateEntityRightActionTest</code> contains tests for the class <code>{@link RotateEntityRightAction}</code>.
 *
 * @generatedBy CodePro at 12/4/16 12:54 PM
 * @author DoubleJ
 * @version $Revision: 1.0 $
 */
public class RotateEntityRightActionTest {
	/**
	...
	public void testActionPerformed_1()
		throws Exception {
		RotateEntityRightAction fixture = RotateEntityRightActionFactory.createInstance();
	...
	/**
	 * Run the RotateEntityRightAction getInstance() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 12/4/16 12:54 PM
	...
	public void testGetInstance_1()
		...
		RotateEntityRightAction result = RotateEntityRightAction.getInstance();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(RotateEntityRightActionTest.class);
	}
}