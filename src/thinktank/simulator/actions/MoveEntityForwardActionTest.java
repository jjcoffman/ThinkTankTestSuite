...
/**
 * The class <code>MoveEntityForwardActionTest</code> contains tests for the class <code>{@link MoveEntityForwardAction}</code>.
 *
 * @generatedBy CodePro at 12/4/16 12:54 PM
 * @author DoubleJ
 * @version $Revision: 1.0 $
 */
public class MoveEntityForwardActionTest {
	/**
	...
	public void testActionPerformed_1()
		throws Exception {
		MoveEntityForwardAction fixture = MoveEntityForwardActionFactory.createInstance();
	...
	/**
	 * Run the MoveEntityForwardAction getInstance() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 12/4/16 12:54 PM
	...
	public void testGetInstance_1()
		...
		MoveEntityForwardAction result = MoveEntityForwardAction.getInstance();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(MoveEntityForwardActionTest.class);
	}
}