...
/**
 * The class <code>DeleteEntityActionTest</code> contains tests for the class <code>{@link DeleteEntityAction}</code>.
 *
...
public class DeleteEntityActionTest {
	...
	public void testActionPerformed_1()
		throws Exception {
		DeleteEntityAction fixture = DeleteEntityActionFactory.createInstance();
		...
		//       at thinktank.simulator.actions.DeleteEntityAction.actionPerformed(DeleteEntityAction.java:53)
	}
	...
	/**
	 * Run the DeleteEntityAction getInstance() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 12/4/16 12:54 PM
	...
	public void testGetInstance_1()
		...
		DeleteEntityAction result = DeleteEntityAction.getInstance();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(DeleteEntityActionTest.class);
	}
}