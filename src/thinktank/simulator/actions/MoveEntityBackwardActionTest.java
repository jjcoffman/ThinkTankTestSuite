...
/**
 * The class <code>MoveEntityBackwardActionTest</code> contains tests for the class <code>{@link MoveEntityBackwardAction}</code>.
 *
 * @generatedBy CodePro at 12/4/16 12:54 PM
 * @author DoubleJ
 * @version $Revision: 1.0 $
 */
public class MoveEntityBackwardActionTest {
	/**
	...
	public void testActionPerformed_1()
		throws Exception {
		MoveEntityBackwardAction fixture = MoveEntityBackwardActionFactory.createInstance();
	...
	/**
	 * Run the MoveEntityBackwardAction getInstance() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 12/4/16 12:54 PM
	...
	public void testGetInstance_1()
		...
		MoveEntityBackwardAction result = MoveEntityBackwardAction.getInstance();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(MoveEntityBackwardActionTest.class);
	}
}