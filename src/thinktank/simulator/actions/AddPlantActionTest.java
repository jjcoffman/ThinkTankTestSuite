...
/**
 * The class <code>AddPlantActionTest</code> contains tests for the class <code>{@link AddPlantAction}</code>.
 *
 * @generatedBy CodePro at 12/4/16 12:54 PM
 * @author DoubleJ
 * @version $Revision: 1.0 $
 */
public class AddPlantActionTest {
	/**
	...
	public void testActionPerformed_1()
		throws Exception {
		AddPlantAction fixture = AddPlantActionFactory.createInstance();
	...
	/**
	 * Run the AddPlantAction getInstance() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 12/4/16 12:54 PM
	...
	public void testGetInstance_1()
		...
		AddPlantAction result = AddPlantAction.getInstance();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AddPlantActionTest.class);
	}
}