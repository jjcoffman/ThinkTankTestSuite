...
/**
 * The class <code>MoveEntityRightActionTest</code> contains tests for the class <code>{@link MoveEntityRightAction}</code>.
 *
 * @generatedBy CodePro at 12/4/16 12:54 PM
 * @author DoubleJ
 * @version $Revision: 1.0 $
 */
public class MoveEntityRightActionTest {
	/**
	...
	public void testActionPerformed_1()
		throws Exception {
		MoveEntityRightAction fixture = MoveEntityRightActionFactory.createInstance();
	...
	/**
	 * Run the MoveEntityRightAction getInstance() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 12/4/16 12:54 PM
	...
	public void testGetInstance_1()
		...
		MoveEntityRightAction result = MoveEntityRightAction.getInstance();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(MoveEntityRightActionTest.class);
	}
}