...
/**
 * The class <code>MoveEntityLeftActionTest</code> contains tests for the class <code>{@link MoveEntityLeftAction}</code>.
 *
 * @generatedBy CodePro at 12/4/16 12:54 PM
 * @author DoubleJ
 * @version $Revision: 1.0 $
 */
public class MoveEntityLeftActionTest {
	/**
	...
	public void testActionPerformed_1()
		throws Exception {
		MoveEntityLeftAction fixture = MoveEntityLeftActionFactory.createInstance();
	...
	/**
	 * Run the MoveEntityLeftAction getInstance() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 12/4/16 12:54 PM
	...
	public void testGetInstance_1()
		...
		MoveEntityLeftAction result = MoveEntityLeftAction.getInstance();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(MoveEntityLeftActionTest.class);
	}
}